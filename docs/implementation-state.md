...
| [Samik](samik/guidance.md) | Android camera, both inference adapters, tracking and search engine | Integrated on device | CameraXAnalyzer, CameraTimestampMapper, Yuv420RgbConverter, KEEP_ONLY_LATEST concurrency gating implemented; bound to live PreviewView (30 FPS) on OPPO CPH2753; 50/50 JVM tests pass, 9/9 OPPO device tests pass | Ingest real-time detections during active navigation |
