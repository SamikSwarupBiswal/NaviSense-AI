...
class MainActivity : AppCompatActivity(), SessionCoordinator.StateChangeListener {
    ...
    private fun findCampusPoi(query: String): MapPOI? {
        ...
        return when {
            ...
            q.contains("health center") || q.contains("medical") || q.contains("clinic") || q.contains("dispensary") || q.contains("hospital") -> engine.getPoi("poi_admin_block")
            q.contains("auditorium") || q.contains("audi") || q.contains("netaji") -> engine.getPoi("poi_academic_block_1")
            q.contains("pool") || q.contains("swimming") || q.contains("gym") || q.contains("badminton") -> engine.getPoi("poi_sports_complex")
            q.contains("atm") || q.contains("sbi") || q.contains("bank") -> engine.getPoi("poi_admin_block")
